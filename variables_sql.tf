...
variable "sql_suffix" {
  type        = string
  description = "The suffix of the Cloud SQL resources"
}

variable "sql_random_instance_name" {
  type        = bool
...
variable "sql_maintenance_window_update_track" {
  description = "The update track of maintenance window for the master instance maintenance.Can be either `canary` or `stable`."
  type        = string
  default     = "canary"
}

variable "sql_database_flags" {
...
variable "sql_read_replica_name_suffix" {
...
variable "sql_additional_databases" {
...
variable "sql_iam_user_emails" {
  description = "A list of IAM users to be created in your cluster"
  type        = list(string)
  default     = []
}

variable "sql_create_timeout" {
  description = "The optional timout that is applied to limit long database creates."
  type        = string
  default     = "15m"
}

variable "sql_update_timeout" {
  description = "The optional timout that is applied to limit long database updates."
  type        = string
  default     = "15m"
}

variable "sql_delete_timeout" {
...
variable "sql_module_depends_on" {
...
variable "sql_read_replica_deletion_protection" {
  description = "Used to block Terraform from deleting replica SQL Instances."
  type        = bool
  default     = false
}

variable "sql_enable_default_db" {
  description = "Enable or disable the creation of the default database"
  type        = bool
  default     = true
}

variable "sql_enable_default_user" {
